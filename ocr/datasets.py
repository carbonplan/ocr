...
datasets = [
    Dataset(
        ...
        prefix='input/fire-risk/vector/CONUS_overture_addresses_2025-09-24.0.parquet',
    ...
    Dataset(
        ...
        bucket='carbonplan-ocr',
        prefix='input/fire-risk/vector/CONUS_overture_buildings_2025-09-24.0.parquet',
        data_format='geoparquet',
        version='v2025-09-24.0',
    ),
    Dataset(
