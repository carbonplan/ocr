...
def write_per_region(*, con: duckdb.DuckDBPyConnection, config: OCRConfig, region_type: RegionType):
    ...
    con.execute(f""" CREATE TEMP TABLE {region_type}_grouped_risk AS SELECT  b.NAME, b.GEOID, a.USFS_RPS, a.wind_risk_2011, a.wind_risk_2047,  ST_X(ST_Centroid(a.geometry)) AS longitude,
