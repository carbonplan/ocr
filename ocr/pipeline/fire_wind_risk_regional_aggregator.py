...
def custom_histogram_query(
    *,
    ...
    SELECT
        ...
        median(a.wind_risk_2011) as rps_2011_median,
        median(a.wind_risk_2047) as rps_2047_median,
        median(a.burn_probability_2011) as bp_2011_median,
        median(a.burn_probability_2047) as bp_2047_median,
        median(a.conditional_risk_usfs) as crps_scott_median,
        median(a.burn_probability_usfs_2011) as bp_2011_riley_median,
        median(a.burn_probability_usfs_2047) as bp_2047_riley_median,
    ...
    SELECT
        ...
        list_concat([z.zero_count_wind_risk_2011], b.nonzero_hist_wind_risk_2011) as risk_score_2011_hist,
        list_concat([z.zero_count_wind_risk_2047], b.nonzero_hist_wind_risk_2047) as risk_score_2047_hist,
        list_concat([z.zero_count_burn_probability_2011], b.nonzero_hist_burn_probability_2011) as bp_2011_hist,
        list_concat([z.zero_count_burn_probability_2047], b.nonzero_hist_burn_probability_2047) as bp_2047_hist,
        list_concat([z.zero_count_conditional_risk_usfs], b.nonzero_hist_conditional_risk_usfs) as crps_scott_hist,
        list_concat([z.zero_count_burn_probability_usfs_2011], b.nonzero_hist_burn_probability_usfs_2011) as bp_2011_riley_hist,
        list_concat([z.zero_count_burn_probability_usfs_2047], b.nonzero_hist_burn_probability_usfs_2047) as bp_2047_riley_hist,
        b.geometry
