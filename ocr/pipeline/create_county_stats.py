...
risk_2011 * 100.0 as risk_2011_horizon_1,
(1.0 - POWER((1 - risk_2011), 15)) * 100.0 as risk_2011_horizon_15,
(1.0 - POWER((1 - risk_2011), 30)) * 100.0 as risk_2011_horizon_30,

risk_2047 * 100.0 as risk_2047_horizon_1,
(1.0 - POWER((1 - risk_2047), 15)) * 100.0 as risk_2047_horizon_15,
(1.0 - POWER((1 - risk_2047), 30)) * 100.0 as risk_2047_horizon_30,

wind_risk_2011 * 100.0 as wind_risk_2011_horizon_1,
(1.0 - POWER((1 - wind_risk_2011), 15)) * 100.0 as wind_risk_2011_horizon_15,
(1.0 - POWER((1 - wind_risk_2011), 30)) * 100.0 as wind_risk_2011_horizon_30,

wind_risk_2047 * 100.0 as wind_risk_2047_horizon_1,
(1.0 - POWER((1 - wind_risk_2047), 15)) * 100.0 as wind_risk_2047_horizon_15,
(1.0 - POWER((1 - wind_risk_2047), 30)) * 100.0 as wind_risk_2047_horizon_30,
...
avg(a.risk_2011_horizon_1) as avg_risk_2011_horizon_1,
avg(a.risk_2011_horizon_15) as avg_risk_2011_horizon_15,
avg(a.risk_2011_horizon_30) as avg_risk_2011_horizon_30,

avg(a.risk_2047_horizon_1) as avg_risk_2047_horizon_1,
avg(a.risk_2047_horizon_15) as avg_risk_2047_horizon_15,
avg(a.risk_2047_horizon_30) as avg_risk_2047_horizon_30,
