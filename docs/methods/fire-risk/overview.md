...
1. Taking baseline burn probability data from Riley et al. 2025 (see [Data Sources](../../reference/data-sources.md)) and spreading it into developed areas using wind-informed blurring
2. Multiplying the wind-adjusted burn probability by Scott et al. 2024 (see [Data Sources](../../reference/data-sources.md)) conditional risk values (cRPS)
3. Sampling the resulting risk surface at building locations from the Overture Maps Foundation buildings dataset (see [Data Sources](../../reference/data-sources.md))
...
- **BP (Burn Probability)**: Annual likelihood that a given pixel burns, derived from wildfire simulations in Riley et al. 2025 (see [Data Sources](../../reference/data-sources.md))
- **cRPS (Conditional Risk to Potential Structures)**: The conditional net value change for a hypothetical structure if it were to burn, from Scott et al. 2024 (see [Data Sources](../../reference/data-sources.md))
...
1. **Fire weather analysis**: Identify wind directions during high fire weather conditions (99th percentile FFWI) from Rasmussen et al. 2023 (see [Data Sources](../../reference/data-sources.md))
...
This differs from the uniform circular blurring in Scott et al. 2024 (see [Data Sources](../../reference/data-sources.md)). The wind-informed approach better represents how embers transport fire downwind from wildland into developed areas.
...
- Convert 270m BP raster from Riley et al. 2025 (see [Data Sources](../../reference/data-sources.md)) to 30m resolution
...
- Intersect 30m RPS raster with Overture Maps building footprints (see [Data Sources](../../reference/data-sources.md))
