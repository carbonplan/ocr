...
| `mean_wind_risk_2011`               | float   | Mean risk score (wind-informed, 2011 climate conditions) across all buildings in region                                                                                                                                            |
| `mean_wind_risk_2047`               | float   | Mean risk score (wind-informed, 2047 climate conditions) across all buildings in region                                                                                                                                            |
...
| `mean_conditional_risk_usfs`        | float   | Mean USFS Conditional Risk to Potential Structures (cRPS) from Scott (2024)                                                                                                                                                        |
| `mean_burn_probability_usfs_2011`   | float   | Mean burn probability (2011 climate conditions) across all buildings in region from Riley et al. (2025)                                                                                                                            |
| `mean_burn_probability_usfs_2047`   | float   | Mean burn probability (2047 climate conditions) across all buildings in region from Riley et al. (2025)                                                                                                                            |
