...
| `longitude`              | degrees | (CSV only) Longitude of building centroid                                                                                                      |
| `latitude`               | degrees | (CSV only) Latitude of building centroid                                                                                                         |
| `geometry`               | Point   | (GeoJSON only) Building centroid as a GeoJSON Point                                                                                                                                |
| **Risk values**          |         |                                                                                                                                                                                    |
