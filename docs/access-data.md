...
| `rps_2011_mean`        | float   | Mean fire risk (wind-informed, 2011 climate conditions) across all buildings in region                                                                                                                                             |
| `rps_2047_mean`        | float   | Mean fire risk (wind-informed, 2047 climate conditions) across all buildings in region                                                                                                                                             |
| `bp_2011_mean`         | float   | Mean burn probability (wind-informed, 2011 climate conditions) across all buildings in region                                                                                                                                      |
| `bp_2047_mean`         | float   | Mean burn probability (wind-informed, 2047 climate conditions) across all buildings in region                                                                                                                                      |
| `crps_scott_mean`      | float   | Mean USFS Conditional Risk to Potential Structures (cRPS) from Scott (2024)                                                                                                                                                        |
...
| `rps_2011_median`      | float   | Median fire risk (wind-informed, 2011 climate conditions) across all buildings in region                                                                                                                                           |
| `rps_2047_median`      | float   | Median fire risk (wind-informed, 2047 climate conditions) across all buildings in region                                                                                                                                           |
| `bp_2011_median`       | float   | Median burn probability (wind-informed, 2011 climate conditions) across all buildings in region                                                                                                                                    |
| `bp_2047_median`       | float   | Median burn probability (wind-informed, 2047 climate conditions) across all buildings in region                                                                                                                                    |
| `crps_scott_median`    | float   | Median USFS Conditional Risk to Potential Structures (cRPS) from Scott (2024)                                                                                                                                                      |
...
| `risk_score_2047_hist` | float[] | Count of buildings with each risk score (wind-informed, 2047 climate conditions).                                                                                                                                                  |
| `bp_2011_hist`         | float[] | TK                                                                                                                                                                                                                                 |
| `bp_2047_hist`         | float[] | TK                                                                                                                                                                                                                                 |
| `crps_scott_hist`      | float[] | TK                                                                                                                                                                                                                                 |
| `bp_2011_riley_hist`   | float[] | TK                                                                                                                                                                                                                                 |
| `bp_2047_riley_hist`   | float[] | TK                                                                                                                                                                                                                                 |
...
| **Risk values**          |         |                                                                                                                                                                                    |
| `rps_2011`               | float   | Fire risk (wind-informed, 2011 climate conditions)                                                                                                                                 |
| `rps_2047`               | float   | Fire risk (wind-informed, 2047 climate conditions)                                                                                                                                 |
| `bp_2011`                | float   | Burn probability (wind-informed, 2011 climate conditions)                                                                                                                          |
| `bp_2047`                | float   | Burn probability (wind-informed, 2047 climate conditions)                                                                                                                          |
| `crps_scott`             | float   | USFS Conditional Risk to Potential Structures (cRPS) from Scott (2024)                                                                                                             |
| `bp_2011_riley`          | float   | Burn probability (2011 climate conditions) from Riley et al. (2025)                                                                                                                |
| `bp_2047_riley`          | float   | Burn probability (2047 climate conditions) from Riley et al. (2025)                                                                                                                |
