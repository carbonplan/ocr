...
| `mean_risk_score_2011`               | float   | Mean risk score (wind-informed, 2011 climate conditions) across all buildings in region                                                                                                                                            |
| `mean_risk_score_2047`               | float   | Mean risk score (wind-informed, 2047 climate conditions) across all buildings in region                                                                                                                                            |
| `mean_burn_probability_2011`         | float   | Mean burn probability (wind-informed, 2011 climate conditions) across all buildings in region                                                                                                                                      |
| `mean_burn_probability_2047`         | float   | Mean burn probability (wind-informed, 2047 climate conditions) across all buildings in region                                                                                                                                      |
| `mean_conditional_risk_scott`        | float   | Mean USFS Conditional Risk to Potential Structures (cRPS) from Scott (2024)                                                                                                                                                        |
...
| `median_risk_score_2011`             | float   | Median risk score (wind-informed, 2011 climate conditions) across all buildings in region                                                                                                                                          |
| `median_risk_score_2047`             | float   | Median risk score (wind-informed, 2047 climate conditions) across all buildings in region                                                                                                                                          |
...
| `median_conditional_risk_scott`      | float   | Median USFS Conditional Risk to Potential Structures (cRPS) from Scott (2024)                                                                                                                                                      |
...
| `risk_score_2011_hist`               | float[] | Count of buildings with each risk score (wind-informed, 2011 climate conditions).                                                                                                                                                  |
| `risk_score_2047_hist`               | float[] | Median risk score (wind-informed, 2047 climate conditions) across all buildings in                                                                                                                                                 |
...
| `conditional_risk_scott_hist`        | float[] | Median risk score (wind-informed, 2047 climate conditions) across all buildings in                                                                                                                                                 |
| `burn_probability_2011_riley_hist`   | float[] | Median risk score (wind-informed, 2047 climate conditions) across all buildings in                                                                                                                                                 |
| `burn_probability_2047_riley_hist`   | float[] | Median risk score (wind-informed, 2047 climate conditions) across all buildings in                                                                                                                                                 |
...
| **Risk values**               |         |                                                                                                                                                                                    |
| `risk_score_2011`             | float   | Risk score (wind-informed, 2011 climate conditions)                                                                                                                                |
| `risk_score_2047`             | float   | Risk score (wind-informed, 2047 climate conditions)                                                                                                                                |
...
| `conditional_risk_scott`      | float   | USFS Conditional Risk to Potential Structures (cRPS) from Scott (2024)                                                                                                             |
| `burn_probability_2011_riley` | float   | Burn probability (2011 climate conditions) from Riley et al. (2025)                                                                                                                |
| `burn_probability_2047_riley` | float   | Burn probability (2047 climate conditions) from Riley et al. (2025)                                                                                                                |
