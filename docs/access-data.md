...
| `mean_fire_risk_2011`                | float   | Mean fire risk (wind-informed, 2011 climate conditions) across all buildings in region                                                                                                                                             |
| `mean_fire_risk_2047`                | float   | Mean fire risk (wind-informed, 2047 climate conditions) across all buildings in region                                                                                                                                             |
...
| `median_fire_risk_2011`              | float   | Median fire risk (wind-informed, 2011 climate conditions) across all buildings in region                                                                                                                                           |
| `median_fire_risk_2047`              | float   | Median fire risk (wind-informed, 2047 climate conditions) across all buildings in region                                                                                                                                           |
...
| **Risk values**               |         |                                                                                                                                                                                    |
| `fire_risk_2011`              | float   | Fire risk (wind-informed, 2011 climate conditions)                                                                                                                                 |
| `fire_risk_2047`              | float   | Fire risk (wind-informed, 2047 climate conditions)                                                                                                                                 |
